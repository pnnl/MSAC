...
def main():
    ...
    parser.add_argument('-n', '--neutral_losses_included', action='store_true')
    ...
    process.process_file(args.input_masses, args.mass_col, args.no_mass, args.adduct_file, args.neutral_loss, args.outname, args.coverage_cutoff, args.restrict)
